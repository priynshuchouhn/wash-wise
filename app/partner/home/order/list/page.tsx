...
export default function Page() {
    ...
    useEffect(() => {
        setIsLoading(true)
        axios.get('/api/partner/order/completedOrder').then(res => {
    ...
    return (
        isLoading || lstOrder.length <=0 ? <div className="flex justify-center items-center"><p className="text-3xl">No completed orders found</p></div> : <div className="grid md:grid-cols-3 gap-4 grid-cols-1">
