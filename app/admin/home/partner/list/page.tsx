...
export default function List() {
    ...
    useEffect(()=>{
        axios.get('/api/admin/partner/list').then((response)=>{
    ...
    return (<>
        <h3 className="text-3xl font-medium text-gray-700">Partner</h3>
        <div className="overflow-hidden rounded-lg border border-gray-200 shadow-md my-5">
            <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
                ...
                <tbody className="divide-y divide-gray-100 border-t border-gray-100">
                    {lstPartner.map((customer:any, index)=> <tr key={customer._id} className="hover:bg-gray-50">
