...
export default function Page(){
  ...
  <div className="2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 px-4 w-96 sm:w-auto">
    <div role="main" className="flex flex-col items-center justify-center">
      <h1 className="text-4xl font-semibold leading-9 text-center text-black-800">
      Welcome to Wash Wise Blog
      </h1>
      <p className="text-base leading-normal text-center text-gray-600 mt-4 lg:w-1/2 md:w-10/12 w-11/12">
      your go-to resource for all things related to laundry care, tips, and tricks! Our blog is designed to provide you with valuable insights, helpful advice, and industry news to help you take better care of your clothes and laundry.
      </p>
    </div>
